...
public class BackJumpState : StateMachineBehaviour
{
    public float backJumpDistance = 3;  // 캐릭터가 뒤로 이동할 거리
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        // 로컬 좌표계를 기준으로 뒤쪽 방향으로 이동할 거리 설정
        Vector3 backwardDirection = -animator.transform.forward;  // 캐릭터의 로컬 Z축의 반대 방향
        endPosition = startPosition + backwardDirection * backJumpDistance;  // 뒤로 이동할 위치 계산
